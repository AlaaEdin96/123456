    ...
    <div class="panel-body">
            ...
            <div id="dataTable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-6">
                <div class="form-group  col-md-12 ">
                   ...
                   <input type="date" wire:model="toDate" class="form-control" name="born" placeholder="تاريخ الميلاد" value="">

                   <label class="control-label" for="name">From Date:</label>
                   <input type="date" wire:model="fromDate" class="form-control" name="born" placeholder="تاريخ الميلاد" value="">
            ...
            <th class="actions text-right dt-not-orderable sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width: 184.574px;">Actions</th></tr>
</thead>
<tbody>
...
<a href="{{ url($url_edit)}}" title="Edit" class="btn btn-sm btn-primary pull-right edit">
